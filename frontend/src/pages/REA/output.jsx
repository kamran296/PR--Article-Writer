...
import SalaryPieChart from './Pichart';
...
const ReportPage = () => {
          ...
          <div>
            {result === "Criteria Satisfied" && (
              <div className="flex flex-row mb-[1rem]">
                <div className="bg-green-500 w-[5rem] h-[2rem] font-semibold text-white text-center py-4 flex items-center justify-center">
                  <p>Satisfied</p>
                </div>
                <p className="ml-[2rem]">
            ...
            {result === "Doubtful" && (
              <div className="flex flex-row mb-[1rem]">
                <div className="bg-yellow-500 w-[5rem] h-[2rem] font-semibold text-white text-center py-4 flex items-center justify-center">
                  <p>Doubtful</p>
                </div>
                <p className="ml-[2rem]">
            ...
            {result === "Unsatisfied" && (
              <div className="flex flex-row mb-[1rem]">
                <div className="bg-red-500 w-[6rem] h-[2rem] font-semibold text-white text-center py-4 flex items-center justify-center">
                  <p>Unsatisfied</p>
                </div>
                <p className="ml-[2rem]">
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div
        className="container mx-[12rem] w-[70rem] bg-slate-50 shadow-lg rounded-lg mt-7 pb-10 px-4 "
        id="main-content"
      >
        <div className="flex justify-center items-center h-[10rem]" id='CompanyLogo'>
          <img src={Logo} className="w-[10%] m-[1rem]" />
        </div>
        {/* Cards Section */}
        <div
          className="flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0 justify-center items-center "
          id="Cards-Section"
        >
          <div className="flex flex-col justify-center items-center bg-white shadow-lg rounded-lg w-[28rem] h-[25rem]" id='Profile'>
            <div className="w-[8rem] h-[7rem] bg-indigo-100 mx-auto rounded-full shadow-lg inset-x-0 top-0 flex items-center justify-center text-indigo-500" >
              <svg
            ...
            <h2 className="text-lg mt-[1rem] font-semibold ">Profile</h2>
          ...
          <div className="flex flex-col justify-center items-center bg-white shadow-lg rounded-lg p-6 w-[28rem] h-[25rem]">
            <h2 className="text-lg font-semibold mb-4">
              Compensation (in USD)
            </h2>
            <div className="w-[26rem] h-[20rem] mb-[1rem] flex justify-center items-center">
              <SalaryPieChart
        ...
        <div
          className="flex flex-col justify-center items-center mt-[2rem] ml-[5rem] bg-white shadow-lg rounded-lg w-[58rem] h-[14rem]"
          id="Status-Summary"
        >
          <div>
        ...
        {/* Job Title 1 */}
        <div className="flex flex-col justify-center items-center mt-[1rem] ml-[5rem] bg-white shadow-lg rounded-lg w-[58rem] h-[23rem]">
          <div className="mb-[rem] mt-[rem]">
            <h2 className="text-lg font-semibold">{inputData.jobTitles[0]}</h2>
          </div>
          <div className="flex">
            <div className="w-[24rem] h-[14rem] mt-[5rem]">
              <BellCurve labels={label1} />
            </div>
            <div className="flex justify-center items-center w-[26rem] ml-[6rem]">
              <InlineComparison
                baseSalary={baseSalary}
                bonus={bonusSalary}
                stocks={stocksComponent}
        ...
        {/* Job Title 2 */}
        <div
          className="flex flex-col justify-center items-center mt-[1rem] ml-[5rem] bg-white shadow-lg rounded-lg w-[58rem] h-[23rem]"
          id="Job-Title-2"
        >
          <div className="mb-[rem] mt-[rem]">
            <h2 className="text-lg font-semibold">{inputData.jobTitles[1]}</h2>
          </div>
          <div className="flex">
            <div className="w-[24rem] h-[14rem] mt-[5rem]">
              <BellCurve labels={label2} />
            </div>
            <div className="flex justify-center items-center w-[26rem] ml-[6rem]">
              <InlineComparison
                baseSalary={baseSalary}
        ...
        {/* Job Title 3 */}
        <div className="flex flex-col justify-center items-center mt-[1rem] ml-[5rem] bg-white shadow-lg rounded-lg w-[58rem] h-[23rem] mb-[1rem]">
          <div className="mb-[rem] mt-[rem]">
            <h2 className="text-lg font-semibold">{inputData.jobTitles[2]}</h2>
          </div>
          <div className="flex">
            <div className="w-[24rem] h-[14rem] mt-[5rem]">
              <BellCurve labels={label3} />
            </div>
            <div className="flex justify-center items-center w-[26rem] ml-[6rem]">
              <InlineComparison
                baseSalary={baseSalary}
        ...
        {/* Table component */}
        <div className="flex flex-col bg-white mt-[1rem] my-2 w-[58rem] ml-[5rem] shadow-lg rounded-lg" id='TableBG'>
          <div className="flex justify-center mb-[1rem] mt-[0.5rem]">
            <h2 className="text-lg font-semibold">Evidence</h2>
          </div>
          <div className="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg" id='Table'>
            <table className="min-w-full bg-white border border-gray-200 shadow-md rounded-lg">
              <thead className="bg-blue-100 text-blue-800">
                <tr>
                  <th className="px-6 text-center py-3 text-left text-sm font-semibold">
                        ...
                        if (displaySalary) {
                          return (
                            <tr className="border-t border-gray-200">
                              ...
                              <td className="px-6 py-4">{SalaryComponent}</td>
                            </tr>
                          );
                        }
        ...
        {/* Next steps ------------------------------------------------------------- */}
        <div className="flex flex-col justify-center items-center pb-[1rem] mt-[1rem] ml-[5rem] bg-white shadow-lg rounded-lg w-[58rem] mb-[1rem]" id='Next-Steps'>
          <div className="mb-[1rem] mt-[1rem]">
        ...
        {/* Evidence to collect -------------------------------------------------- */}
        <div
          className="flex flex-col justify-center items-center pb-[1rem] mt-[1rem] ml-[5rem] bg-white shadow-lg rounded-lg w-[58rem] mb-[1rem]"
          id='Evidence'
        >
          <div className="mb-[1rem] mt-[2rem]">
            <h2 className="text-xl font-semibold">Evidence Collection</h2>
          </div>
          <div className="h-full w-[95%] rounded-lg bg-gradient-to-b from-blue-50 to-gray-100 px-[2rem] pt-12 p-4">
          <div className="grid gap-14 md:grid-cols-2 md:gap-5">
            {/* Card 1 */}
            <div className="rounded-xl bg-white p-6 text-center shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full bg-sky-500 shadow-lg shadow-sky-400/40 print-bg-color print-shadow">
                <svg
                  viewBox="0 0 33 46"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 text-white print-svg-color"
                >
                  <path
            ...
            <div
              data-aos-delay={150}
              className="rounded-xl bg-white p-6 text-center shadow-lg hover:shadow-2xl transition-shadow duration-300"
            >
              <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full bg-sky-500 shadow-lg shadow-sky-400/40 print-bg-color print-shadow">
              <svg
                  viewBox="0 0 33 46"
            ...
            {/* Partition */}
            <div className="h-full w-full  pt-12 p-4" id='Card-Partition'>
            <div className="grid gap-14 md:grid-cols-2 md:gap-5">
            {/* Card 3 */}
            <div
              data-aos-delay={300}
        ...
        <div
          className="flex flex-col justify-center items-center p-[1rem] pb-[2rem] mt-[1rem] ml-[5rem] bg-white shadow-lg rounded-lg w-[58rem]"
          id="SourceLinks"
        >
            <div className="mb-[1rem] mt-[1rem]">
        ...
        {/* Print Button ------------------------------------------------------------ */}
        <div className="mt-8 flex justify-center" id="Print-btn">
