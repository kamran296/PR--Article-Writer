    ...
    <div style={{ width: "100%", height: "100%" }}>
      ...
      >
        {labels && labels.length > 0 && (
          <>
            <div
              className="flex flex-col text-[1.5rem]"
              style={{ position: "absolute", left: "16%", top: "-16px" }}
            >
              <div> Median</div>
              <div>${labels[1]}</div>
            </div>
            <div
              className="flex flex-col text-[1.5rem]"
              style={{ position: "absolute", left: "51%", top: "115px" }}
            >
              <div> {lowLabel.label}</div>
              <div>${lowLabel.value}</div>
            </div>
            <div
              className="flex flex-col w-[11rem] text-[1.5rem]"
              style={{ position: "absolute", left: "75%", top: "143px" }}
            >
