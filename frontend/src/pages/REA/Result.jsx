...
const meanHr = (additionalResponse.averageSalary / 2080).toFixed(2);
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      >
        <div
          className="flex justify-center items-center h-[16rem]"
          id="CompanyLogo"
        >
        ...
        >
          <div
            className="flex flex-col justify-center items-center bg-white shadow-lg rounded-lg w-[45rem] h-[40rem]"
            id="Profile"
          >
            ...
            <h2 className="text-[1.75rem] mt-[1.5rem] font-semibold ">
              Profile
            </h2>
        ...
        >
          <div>
            <h2 className="text-[1.65rem] font-semibold mb-8">
              Status Summary
            </h2>
          </div>
        ...
        {/* Table component */}
        <div
          className="flex flex-col bg-white mt-[1rem] my-2 w-[93rem] ml-[5rem] shadow-lg rounded-lg"
          id="TableBG"
        >
          ...
          <div
            className="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-12 pt-6 rounded-bl-lg rounded-br-lg"
            id="Table"
          >
            <table className="min-w-full bg-white border border-gray-200 shadow-md rounded-lg">
              <thead className="bg-blue-100 text-blue-800">
              ...
              <tbody className="text-gray-900 text-[1.5rem]">
                {jobTitle1Response && (
                  <>
                            ...
                            <tr className="border-t border-gray-200">
                              <td className="pl-10 pr-6 py-8">
                                <div className="text-[1.5rem] font-semibold text-blue-900">
                                  indeed.com for {inputData.jobTitles[0]} in{" "}
                                  {inputData.location}
                                </div>
                              </td>
                              <td className="px-10 py-8">
                              ...
                              <td className="px-10 py-8 ">
                                ...
                                {inputData.jobTitles[0]} counterparts in{" "}
                                {inputData.location}
                              </td>
                        ...
                        if (displaySalary) {
                          return (
                            <tr className="border-t border-gray-200">
                              <td className="pl-10 pr-6 py-8">
                                <div className="text-[1.5rem] font-semibold text-blue-900">
                                  talent.com for {inputData.jobTitles[0]} in{" "}
                                  {inputData.location}
                                </div>
                              </td>
                              <td className="px-10 py-8">
                        ...
                        if (displaySalary) {
                          return (
                            <tr className="border-t border-gray-200">
                              <td className="pl-10 pr-6 py-8">
                                <div className="text-[1.5rem] font-semibold text-blue-900">
                                  salary.com for {inputData.jobTitles[0]} in{" "}
                                  {inputData.location}
                                </div>
                              </td>
                              <td className="px-10 py-8">
                    ...
                    {jobTitle1Response.highSalaries.levels !== 0 &&
                      (() => {
                        const highSalary =
                          jobTitle1Response.highSalaries.levels;
                        const totalCompensation =
                          baseSalary + bonusSalary + stocksComponent;
                        let displaySalary = null;
                        let SalaryComponent = null;
                            ...
                            <tr className="border-t border-gray-200">
                              <td className="px-10 py-8">
                                <div className="text-[1.5rem] font-medium text-blue-900">
                                  levels.fyi for {inputData.jobTitles[0]} in{" "}
                                  {inputData.location}
                                </div>
                              </td>
                              <td className="px-10 py-8">
                ...
                {jobTitle2Response && (
                  <>
                    ...
                    {jobTitle2Response.highSalaries.levels !== 0 &&
                      (() => {
                        const highSalary =
                          jobTitle2Response.highSalaries.levels;
                        const totalCompensation =
                          baseSalary + bonusSalary + stocksComponent;
                        let displaySalary = null;
                        let SalaryComponent = null;
                        ...
                        if (displaySalary) {
                          return (
                            <tr className="border-t border-gray-200">
                              <td className="px-10 py-8">
                                <div className="text-[1.5rem] font-medium text-blue-900">
                                  levels.fyi for {inputData.jobTitles[1]} in{" "}
                                  {inputData.location}
                                </div>
                              </td>
                              <td className="px-10 py-8">
                                <div className="text-[1.5rem] text-blue-600 font-semibold">
                                  $
                                  {jobTitle2Response.highSalaries.levels.toLocaleString()}
                                </div>
                              </td>
                              <td className="px-10 py-8">
                                Mr {inputData.firstName}'s Salary of $
                ...
                {jobTitle3Response && (
                  <>
                        ...
                        if (displaySalary) {
                          return (
                            <tr className="border-t border-gray-200">
                              <td className="pl-10 pr-6 py-8">
                                <div className="text-[1.5rem] font-semibold text-blue-900">
                                  indeed.com for {inputData.jobTitles[2]} in{" "}
                                  {inputData.location}
                                </div>
                              </td>
                              <td className="px-10 py-8">
                        ...
                        if (displaySalary) {
                          return (
                            <tr className="border-t border-gray-200">
                              <td className="pl-10 pr-6 py-8">
                                <div className="text-[1.5rem] font-semibold text-blue-900">
                                  talent.com for {inputData.jobTitles[2]} in{" "}
                                  {inputData.location}
                                </div>
                              </td>
                              <td className="px-10 py-8">
                        ...
                        if (displaySalary) {
                          return (
                            <tr className="border-t border-gray-200">
                              <td className="pl-10 pr-6 py-8">
                                <div className="text-[1.5rem] font-semibold text-blue-900">
                                  salary.com for {inputData.jobTitles[2]} in{" "}
                                  {inputData.location}
                                </div>
                              </td>
                              <td className="px-10 py-8">
                    ...
                    {jobTitle3Response.highSalaries.levels !== 0 &&
                      (() => {
                        const highSalary =
                          jobTitle3Response.highSalaries.levels;
                        const totalCompensation =
                          baseSalary + bonusSalary + stocksComponent;
                        let displaySalary = null;
                        let SalaryComponent = null;
                        ...
                        if (displaySalary) {
                          return (
                            <tr className="border-t border-gray-200">
                              <td className="px-10 py-8">
                                <div className="text-[1.5rem] font-medium text-blue-900">
                                  levels.fyi for {inputData.jobTitles[2]} in{" "}
                                  {inputData.location}
                                </div>
                              </td>
                              <td className="px-10 py-8">
                                <div className="text-[1.5rem] text-blue-600 font-semibold">
                                  $
                                  {jobTitle3Response.highSalaries.levels.toLocaleString()}
                                </div>
                              </td>
        ...
        {/* Next steps ------------------------------------------------------------- */}
        <div
          className="flex flex-col justify-center items-center pb-[1rem] mt-[2rem] ml-[5rem] bg-white shadow-lg rounded-lg w-[93rem] mb-[2rem]"
          id="Next-Steps"
        >
            ...
            <div className="grid gap-14 md:grid-cols-2 md:gap-7">
              ...
              <div className="rounded-xl bg-white p-10 text-center shadow-lg hover:shadow-2xl transition-shadow duration-300">
                ...
                <p className="px-4 text-[1.5rem] text-gray-600">
                  Collect your pay stubs for the last 6 months (3 months at
                  least).
                </p>
              </div>
              {/* Card 2 */}
              ...
              >
                ...
                <p className="px-4 text-[1.5rem] text-gray-600">
                  Store copies of your contracts that detail your salary (If
                  any).
                </p>
              </div>
            </div>
              ...
              <div className="grid gap-14 md:grid-cols-2 md:gap-7">
                ...
                >
                  ...
                  <p className="px-4 text-gray-600 text-[1.5rem]">
                    Collect letters from your employer about salary increases or
                    promotions. (If any).
                  </p>
                </div>
                {/* Card 4 */}
