...
router.route("/original-finetune").post(loaOriginalController.fineTune);
...
router.route("/critical-finetune").post(loaCriticalController.fineTune);
...
router.route("/research-finetune").post(loaResearchController.fineTune);
